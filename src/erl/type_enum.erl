...
% Check if the typedef is locally shadowed by an assignment (This won't match on typedefs or enums)
scan([{identifier, L0, Name}, {';', L1} | Tokens], Types, Enums) ->
  {Adj, Rest} = scan(Tokens, lists:delete(Name, Types), lists:delete(Name, Enums)),
  {[{identifier, L0, Name}, {';', L1} | Adj], Rest};
...
% Stop scanning at the close of a namespace and revert to the previous namespace for the rest of the tokens
