...
yystate(111, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
yystate(111, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 101 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(109, [112|Ics], Line, Tlen, _, _) ->
    yystate(77, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(109, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
yystate(109, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 111 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
yystate(109, [C|Ics], Line, Tlen, _, _) when C >= 113, C =< 122 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
yystate(109, Ics, Line, Tlen, _, _) ->
    {4,Tlen,Ics,Line,109};
yystate(108, [92|Ics], Line, Tlen, Action, Alen) ->
    yystate(44, Ics, Line, Tlen+1, Action, Alen);
yystate(108, [39|Ics], Line, Tlen, Action, Alen) ->
...
yystate(108, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 38 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
yystate(108, [C|Ics], Line, Tlen, Action, Alen) when C >= 40, C =< 47 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
yystate(108, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(108, Ics, Line, Tlen+1, Action, Alen);
yystate(108, [C|Ics], Line, Tlen, Action, Alen) when C >= 58, C =< 64 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
yystate(108, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 70 ->
    yystate(108, Ics, Line, Tlen+1, Action, Alen);
yystate(108, [C|Ics], Line, Tlen, Action, Alen) when C >= 71, C =< 91 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
yystate(108, [C|Ics], Line, Tlen, Action, Alen) when C >= 93, C =< 96 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
yystate(108, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 102 ->
    yystate(108, Ics, Line, Tlen+1, Action, Alen);
yystate(108, [C|Ics], Line, Tlen, Action, Alen) when C >= 103 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
...
yystate(106, [111|Ics], Line, Tlen, _, _) ->
    yystate(90, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(103, Ics, Line, Tlen, _, _) ->
    {4,Tlen,Ics,Line,103};
yystate(102, [107|Ics], Line, Tlen, _, _) ->
    yystate(81, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(102, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
yystate(102, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 106 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
yystate(102, [C|Ics], Line, Tlen, _, _) when C >= 108, C =< 122 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(100, Ics, Line, Tlen, _, _) ->
    {4,Tlen,Ics,Line,100};
yystate(99, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(97, Ics, Line, Tlen+1, Action, Alen);
yystate(99, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 70 ->
    yystate(97, Ics, Line, Tlen+1, Action, Alen);
yystate(99, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 102 ->
    yystate(97, Ics, Line, Tlen+1, Action, Alen);
...
yystate(98, [10|Ics], Line, Tlen, _, _) ->
    yystate(98, Ics, Line+1, Tlen+1, 6, Tlen);
...
yystate(97, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
yystate(97, [C|Ics], Line, Tlen, Action, Alen) when C >= 35, C =< 47 ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
yystate(97, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(97, Ics, Line, Tlen+1, Action, Alen);
yystate(97, [C|Ics], Line, Tlen, Action, Alen) when C >= 58, C =< 64 ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
yystate(97, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 70 ->
    yystate(97, Ics, Line, Tlen+1, Action, Alen);
yystate(97, [C|Ics], Line, Tlen, Action, Alen) when C >= 71, C =< 91 ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
yystate(97, [C|Ics], Line, Tlen, Action, Alen) when C >= 93, C =< 96 ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
yystate(97, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 102 ->
    yystate(97, Ics, Line, Tlen+1, Action, Alen);
yystate(97, [C|Ics], Line, Tlen, Action, Alen) when C >= 103 ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
...
yystate(92, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 104 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
yystate(92, [C|Ics], Line, Tlen, _, _) when C >= 106, C =< 114 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
yystate(92, [C|Ics], Line, Tlen, _, _) when C >= 116, C =< 122 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(89, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 101 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
yystate(89, [C|Ics], Line, Tlen, _, _) when C >= 103, C =< 109 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(84, [116|Ics], Line, Tlen, _, _) ->
    yystate(112, Ics, Line, Tlen+1, 4, Tlen);
yystate(84, [103|Ics], Line, Tlen, _, _) ->
...
yystate(84, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
yystate(84, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 102 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
yystate(84, [C|Ics], Line, Tlen, _, _) when C >= 104, C =< 115 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(83, Ics, Line, Tlen, _, _) ->
    {4,Tlen,Ics,Line,83};
yystate(82, [126|Ics], Line, Tlen, Action, Alen) ->
...
yystate(82, [123|Ics], Line, Tlen, Action, Alen) ->
    yystate(66, Ics, Line, Tlen+1, Action, Alen);
yystate(82, [119|Ics], Line, Tlen, Action, Alen) ->
    yystate(34, Ics, Line, Tlen+1, Action, Alen);
yystate(82, [118|Ics], Line, Tlen, Action, Alen) ->
...
yystate(82, [106|Ics], Line, Tlen, Action, Alen) ->
    yystate(113, Ics, Line, Tlen+1, Action, Alen);
yystate(82, [107|Ics], Line, Tlen, Action, Alen) ->
    yystate(113, Ics, Line, Tlen+1, Action, Alen);
yystate(82, [105|Ics], Line, Tlen, Action, Alen) ->
    yystate(89, Ics, Line, Tlen+1, Action, Alen);
yystate(82, [104|Ics], Line, Tlen, Action, Alen) ->
    yystate(113, Ics, Line, Tlen+1, Action, Alen);
yystate(82, [103|Ics], Line, Tlen, Action, Alen) ->
...
yystate(82, [42|Ics], Line, Tlen, Action, Alen) ->
    yystate(50, Ics, Line, Tlen+1, Action, Alen);
yystate(82, [41|Ics], Line, Tlen, Action, Alen) ->
    yystate(66, Ics, Line, Tlen+1, Action, Alen);
yystate(82, [40|Ics], Line, Tlen, Action, Alen) ->
    yystate(66, Ics, Line, Tlen+1, Action, Alen);
yystate(82, [39|Ics], Line, Tlen, Action, Alen) ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(82, [38|Ics], Line, Tlen, Action, Alen) ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
yystate(82, [37|Ics], Line, Tlen, Action, Alen) ->
    yystate(50, Ics, Line, Tlen+1, Action, Alen);
...
yystate(82, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(113, Ics, Line, Tlen+1, Action, Alen);
yystate(82, [C|Ics], Line, Tlen, Action, Alen) when C >= 109, C =< 113 ->
    yystate(113, Ics, Line, Tlen+1, Action, Alen);
yystate(82, [C|Ics], Line, Tlen, Action, Alen) when C >= 120, C =< 122 ->
    yystate(113, Ics, Line, Tlen+1, Action, Alen);
yystate(82, Ics, Line, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,82};
yystate(81, [95|Ics], Line, Tlen, _, _) ->
    yystate(113, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(78, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
yystate(78, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 103 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
yystate(78, [C|Ics], Line, Tlen, _, _) when C >= 105, C =< 122 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(76, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(108, Ics, Line, Tlen+1, Action, Alen);
yystate(76, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 70 ->
    yystate(108, Ics, Line, Tlen+1, Action, Alen);
yystate(76, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 102 ->
    yystate(108, Ics, Line, Tlen+1, Action, Alen);
...
yystate(72, Ics, Line, Tlen, _, _) ->
    {4,Tlen,Ics,Line,72};
yystate(71, [120|Ics], Line, Tlen, Action, Alen) ->
    yystate(99, Ics, Line, Tlen+1, Action, Alen);
yystate(71, [118|Ics], Line, Tlen, Action, Alen) ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
yystate(71, [116|Ics], Line, Tlen, Action, Alen) ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
yystate(71, [114|Ics], Line, Tlen, Action, Alen) ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
...
yystate(71, [34|Ics], Line, Tlen, Action, Alen) ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
yystate(71, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 55 ->
...
yystate(65, [C|Ics], Line, Tlen, Action, Alen) when C >= 35, C =< 47 ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
yystate(65, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 55 ->
    yystate(33, Ics, Line, Tlen+1, Action, Alen);
yystate(65, [C|Ics], Line, Tlen, Action, Alen) when C >= 56, C =< 91 ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
...
yystate(64, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 38 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
yystate(64, [C|Ics], Line, Tlen, Action, Alen) when C >= 40, C =< 47 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
yystate(64, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 55 ->
    yystate(48, Ics, Line, Tlen+1, Action, Alen);
yystate(64, [C|Ics], Line, Tlen, Action, Alen) when C >= 56, C =< 91 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
...
yystate(63, [105|Ics], Line, Tlen, _, _) ->
    yystate(80, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(53, [122|Ics], Line, Tlen, _, _) ->
    yystate(85, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(53, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 102 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
yystate(53, [C|Ics], Line, Tlen, _, _) when C >= 104, C =< 121 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(44, [34|Ics], Line, Tlen, Action, Alen) ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
yystate(44, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 55 ->
...
yystate(36, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
yystate(36, [C|Ics], Line, Tlen, _, _) when C >= 98, C =< 103 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
yystate(36, [C|Ics], Line, Tlen, _, _) when C >= 105, C =< 110 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(35, Ics, Line, Tlen, _, _) ->
    {4,Tlen,Ics,Line,35};
yystate(34, [104|Ics], Line, Tlen, _, _) ->
...
yystate(33, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
yystate(33, [C|Ics], Line, Tlen, Action, Alen) when C >= 35, C =< 47 ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
yystate(33, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 55 ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
yystate(33, [C|Ics], Line, Tlen, Action, Alen) when C >= 56, C =< 91 ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
...
yystate(26, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 107 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
yystate(26, [C|Ics], Line, Tlen, _, _) when C >= 111, C =< 119 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(13, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 103 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
yystate(13, [C|Ics], Line, Tlen, _, _) when C >= 106, C =< 115 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
yystate(13, [C|Ics], Line, Tlen, _, _) when C >= 120, C =< 122 ->
    yystate(113, Ics, Line, Tlen+1, 4, Tlen);
...
-file("/home/tmoores/Development/c89_beam/src/parsing/lexer.xrl", 14).
yyaction_0(TokenChars, TokenLine) ->
     string_escape (TokenLine, tl (TokenChars)) .

-compile({inline,yyaction_1/2}).
-file("/home/tmoores/Development/c89_beam/src/parsing/lexer.xrl", 15).
yyaction_1(TokenChars, TokenLine) ->
